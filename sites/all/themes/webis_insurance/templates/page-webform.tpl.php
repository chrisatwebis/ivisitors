...
<head>
  ...
  <?php print $scripts; ?>
  <link rel="icon" type="image/gif" href="<?php print base_path().path_to_theme();?>/animated_favicon1.gif" >
  <script type="text/javascript">var switchTo5x=true;</script>
  <script type="text/javascript" src="http://w.sharethis.com/button/buttons.js"></script>
  <script type="text/javascript">stLight.options({publisher: "44c2fae7-2b8e-429b-b649-7c675050657d", doNotHash: false, doNotCopy: false, hashAddressBar: false});</script>
</head>
<body class="<?php print $classes; ?>">
  <div id="container">
    ...
    <?php if ($user1 or $user2 or $user3 or $user4): ?>
      <div id="section1">
      <div class="sections" cellspacing="0" cellpadding="0">
        <?php if ($user1): ?><div class="section u1"><?php print $user1; ?></div><?php endif; ?>
        <?php if ($user2): ?><div class="section u2 <?php if ($user1): ?>divider<?php endif; ?>"><?php print $user2; ?></div><?php endif; ?>
        <?php if ($user3): ?><div class="section u3 <?php if ($user1 or $user2): ?>divider<?php endif; ?>"><?php print $user3; ?></div><?php endif; ?>
        <?php if ($user4): ?><div class="section u4 <?php if ($user1 or $user2 or $user3): ?>divider<?php endif; ?>"><?php print $user4; ?></div><?php endif; ?>
      </div>
      </div>  <!-- /section1 -->
    <?php endif; ?>
        ...
        <div id="main-content">
          ...
          <?php if ($title or $tabs): ?>
            <div id="main-content-header">
              <?php if ($title): ?><h1 id="page-title"><?php print t($title); ?></h1><?php endif; ?>
              <?php if ($tabs): ?>
    ...
    <?php if ($user5 or $user6 or $user7 or $user8): ?>
      <div id="section2">
      <div class="sections" cellspacing="0" cellpadding="0">
        <?php if ($user5): ?><div class="section u5"><?php print $user5; ?></div><?php endif; ?>
        <?php if ($user6): ?><div class="section u6 <?php if ($user5): ?>divider<?php endif; ?>"><?php print $user6; ?></div><?php endif; ?>
        <?php if ($user7): ?><div class="section u7 <?php if ($user5 or $user6): ?>divider<?php endif; ?>"><?php print $user7; ?></div><?php endif; ?>
        <?php if ($user8): ?><div class="section u8 <?php if ($user5 or $user6 or $user7): ?>divider<?php endif; ?>"><?php print $user8; ?></div><?php endif; ?>
      </div>
      </div>  <!-- /section2 -->
    <?php endif; ?>
