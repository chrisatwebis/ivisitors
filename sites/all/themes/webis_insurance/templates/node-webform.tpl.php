...
<div<?php print $article_id ? ' id="'. $article_id .'"' : ''; ?> class="<?php print $classes; ?>">
  ...
  <?php 
    if( $node->nid==84 && drupal_is_front_page() ){
  	  if(function_exists("site_helper_get_price_search_steps")){
		  	print site_helper_get_price_search_steps(1, "long");
		  }else{
		  	print t("Can't find function 'site_helper_get_price_search_steps', please make sure 'site_helper' module is enabled.");
		  }
    }
